...
// Registered in Services.yaml (after "ai-label/add-ai-meta-fields-to-tca", so the
// aiMetadata tab already exists), not via #[AsEventListener] - see AddAiMetaFieldsToTca for why.
