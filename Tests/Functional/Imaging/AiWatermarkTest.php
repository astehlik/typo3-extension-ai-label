...
final class AiWatermarkTest extends FunctionalTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // v12 still defaults this to 'RGB', which ImageMagick 7 renders visibly darker
        // than the source (v13+ default to sRGB) - the brightness assertions below
        // compare against the untouched picture and would misjudge the badge's effect.
